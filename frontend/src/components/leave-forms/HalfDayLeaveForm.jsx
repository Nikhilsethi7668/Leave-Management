// src/components/leave-forms/HalfDayLeaveForm.jsx
import React, { useState } from "react";

const HalfDayLeaveForm = ({ categories, onSubmit, onCancel }) => {
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md border">
            <h3 className="text-lg font-semibold mb-4">Half Day Leave Application</h3>
                    ...
                    <div className="flex gap-4">
                        <label className="flex items-center">
                            <input
                                type="radio"
                                value="first-half"
                                checked={formData.halfDayPeriod === "first-half"}
                        ...
                        <label className="flex items-center">
                            <input
                                type="radio"
                                value="second-half"
                                checked={formData.halfDayPeriod === "second-half"}
                                onChange={(e) => handleChange('halfDayPeriod', e.target.value)}
                                className="mr-2"
                            />
                            Second Half (1 PM - 6 PM)
                        </label>
                    </div>
                </div>
